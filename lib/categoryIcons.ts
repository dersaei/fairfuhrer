// Mapowanie ID kategorii Directus → ścieżki SVG ikon Lucide
// Ścieżki wyekstrahowane z lucide-react@0.577.0, viewBox="0 0 24 24"
//
// ID kategorii:
//   1 = Erlebnisse       → Binoculars
//   2 = Gastronomie & Übernachten → Utensils
//   3 = Einkaufen        → ShoppingCart
//   5 = Engagement       → HeartHandshake
//   8 = Unternehmen      → Building2

export const CATEGORY_ICON_PATHS: Record<number, string> = {
  1: // Binoculars
...
// Fallback — MapPin (używany gdy brak mapowania dla danego ID)
export const DEFAULT_ICON_PATHS =
  '<path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/>';

export function getCategoryIconPaths(categoryId: number): string {
  return CATEGORY_ICON_PATHS[categoryId] ?? DEFAULT_ICON_PATHS;
}
