  ...
  return (
    <header className={styles.header}>
      ...
      <div className={styles.social}>
        ...
        >
          <svg width="24" height="24" fill="currentColor" viewBox="0 0 448 512" overflow="visible">
        ...
        <a
          ...
          aria-label="Facebook"
        >
          <svg width="24" height="24" fill="currentColor" viewBox="0 0 320 512" overflow="visible">
